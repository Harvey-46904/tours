            ...
            <div class="container-fluid">
                <div class="row">
                    <div class="col-md-12">
                        ...
                        <div class="header">
                                <h4 class="title">AÑADIR NUEVA IMAGEN GALERÍA</h4>
                                <p class="category">Añadir aquí las imágenes que serán publicadas en el la galería del portal web Special Vans</p>
                        </div>
